# PlexBackup.ps1
This [PowerShell script](PlexBackup.ps1) can back up and restore [Plex](https://www.plex.tv/) application data files on a Windows system. This document explains how it works and how to use it. If you don't care about the details and just want to see the  instruction, see [Getting Started](GETTING%20STARTED.md).
